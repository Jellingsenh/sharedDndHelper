...
class DungeonMasterOptions extends React.Component {
  ...
  getTime = async () => {
      const res = await  fetch('http://192.168.19.1:9001/playermenu/gettimestring', {
          method: 'GET',
      })
      .then((response) => {
...
async function submitRounds() {
  // console.log('rounds to add:', roundsToAdd)
  if (roundsToAdd >= 0 ) {
    await fetch('http://192.168.19.1:9001/playermenu/addrounds', {
        method: 'POST',
        body: roundsToAdd
    })
    .catch(err => {
    ...
    await fetch('http://192.168.19.1:9001/playermenu/subtractrounds', {
        method: 'POST',
        body: roundsToAdd*-1
    })
    .catch(err => {
...
async function submitMinutes() {
  if (minutesToAdd >= 0 ) {
    await fetch('http://192.168.19.1:9001/playermenu/addminutes', {
        method: 'POST',
        body: minutesToAdd
    })
    .catch(err => {
    ...
    await fetch('http://192.168.19.1:9001/playermenu/subtractminutes', {
        method: 'POST',
        body: minutesToAdd*-1
    })
    .catch(err => {
...
async function submitHours() {
  if (hoursToAdd >= 0 ) {
    await fetch('http://192.168.19.1:9001/playermenu/addhours', {
        method: 'POST',
        body: hoursToAdd
    })
    .catch(err => {
    ...
    await fetch('http://192.168.19.1:9001/playermenu/subtracthours', {
        method: 'POST',
        body: hoursToAdd*-1
    })
    .catch(err => {
...
async function submitDays() {
  if (daysToAdd >= 0 ) {
    await fetch('http://192.168.19.1:9001/playermenu/adddays', {
        method: 'POST',
        body: daysToAdd
    })
    .catch(err => {
    ...
    await fetch('http://192.168.19.1:9001/playermenu/subtractdays', {
        method: 'POST',
        body: daysToAdd*-1
    })
    .catch(err => {
...
async function submitYears() {
  if (yearsToAdd >= 0 ) {
    await fetch('http://192.168.19.1:9001/playermenu/addyears', {
        method: 'POST',
        body: yearsToAdd
    })
    .catch(err => {
    ...
    await fetch('http://192.168.19.1:9001/playermenu/subtractyears', {
        method: 'POST',
        body: yearsToAdd*-1
    })
    .catch(err => {
...
async function resetTime() {
  await fetch('http://192.168.19.1:9001/playermenu/resettime', {
      method: 'GET',
  })
  .catch(err => {
      console.log(err);
