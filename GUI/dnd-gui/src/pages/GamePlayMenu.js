...
class GamePlayMenu extends React.Component {
    ...
    getTurns = async () => {
        try {
            ...
            const res = await fetch('http://192.168.19.1:9001/playermenu/getcurrentcharacter', {
                method: 'GET',
            })
            ...
            const res2 = await fetch('http://192.168.19.1:9001/playermenu/getnextcharacter', {
                method: 'GET',
            })
            .then(response => response.text())
            .then(response => {
    ...
    doNextTurn = async () => {
        const res = await  fetch('http://192.168.19.1:9001/playermenu/nextturn', {
            method: 'GET',
        })
        .then(() => {
            // refresh page
